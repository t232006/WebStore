...
{
    /// <inheritdoc />
    public partial class BURMig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogUserRate", x => new { x.BlogID, x.UserID });
                    table.ForeignKey(
                        name: "FK_BlogUserRate_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogUserRate_Blogs_BlogID",
                        column: x => x.BlogID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogUserRate_BlogID",
                table: "BlogUserRate",
                column: "BlogID");

            migrationBuilder.CreateIndex(
                name: "IX_BlogUserRate_UserID",
                table: "BlogUserRate",
                column: "UserID");
